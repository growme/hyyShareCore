...
public class RandomValueUtil {
	...
	public static void main(String[] args) {
		for (int i = 0; i < 25; i++) {
			CPSUtil.xprint("INSERT INTO `total_money_rank` (`rank_name`, `total_money`, `rank_mobile`,`update_time`) VALUES ('"+getChineseName()+"','"+RandomNum.getRandDoubleVal(500)+"','"+getTel()+"','"+CPSUtil.getCurrentTime()+"'); ");
		}
	}
}
