...
public class Tools {
	...
	public static int getRandomNum(int digit) {
		digit--;
		Random r = new Random();
		return r.nextInt((int) Math.pow(10, digit) * 9) + (int) Math.pow(10, digit);// (Math.random()*(999999-100000)+100000)
	}

	public static void main(String[] args) {
		System.out.println(Math.pow(10, 8) * 9);
	 ...
	 * MD5.md5(paraname+DateUtil.getDateToSDF(DateUtil.,
	 * date)+",fh,").equals(FKEY); }
	 */
