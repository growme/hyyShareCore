package com.ccnet.core.common.utils.email;
...
public class EmailHandle {
    ...
    public EmailHandle(String smtp,String port,boolean ssl) {
        sendUserName = "";
        sendUserPass = "";
        setSmtpHost(smtp,port,ssl);
        createMimeMessage();
    }
 
    private void setSmtpHost(String hostName,String port,boolean ssl) {
        if (props == null){
