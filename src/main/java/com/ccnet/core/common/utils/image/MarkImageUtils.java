...
public class MarkImageUtils {
	...
	public static void main(String[] args) {
		String output = "D://";
		String source = "D://barcode_8.jpg"; // 源图片路径
		String icon = "F:/images/icon2.png"; // 覆盖图片路径
		String imageName = "wechat"; // 图片名称
		String imageType = "jpg"; // 图片类型jpg,jpeg,png,gif
		
		String text1 = "同城交流群";
		String text2 = "该二维码7天内(5月18日前)有效，重新进入将更新";
		
		int x1=260;
		int y1=400;
		int x2=95;
		int y2=1100;
		int size1=26;int size2=24;
		int size = 4; // 马赛克大小
		...
		// //给图片添加文字水印
		 ...
		 result =  MarkImageUtils.markImageByMoreText(source,output,imageName,imageType,color1,color2,text1,x1,y1,text2,x2,y2, size1, size2);
		// result =
	 ...
	 *            水印图片旋转角度，为null表示不旋转
	 */
	public static String markImageByMoreIcon(String icon, String source,
			String output, String imageName, String imageType, Integer degree) {
		...
		try {
			...
			for (int i = 0; i < space; i++) {
				...
				g.setComposite(AlphaComposite.getInstance(
						AlphaComposite.SRC_ATOP, clarity));
				// 表示水印图片的坐标位置(x,y)
	 ...
	 *            水印图片旋转角度，为null表示不旋转
	 */
	public static String markImageBySingleIcon(String icon, String source,
			String output, String imageName, String imageType, Integer degree) {
		String result = "添加图片水印出错";
		try {
			File file = new File(source);
	...
	public static String markImageByMoreText(String source, String output,
			String imageName, String imageType, Color color1,Color color2, String word1,int x1,int y1,String word2,int x2,int y2,int size1,int size2) {
		...
		try {
			...
			// 设置水印字体样式
			Font font1 = new Font("微软雅黑", Font.PLAIN, size1);
			Font font2 = new Font("微软雅黑", Font.PLAIN, size2);
			// 根据图片的背景设置水印颜色
			g.setFont(font1);
	 ...
	 *            水印文字旋转角度，为null表示不旋转
	 */
	public static String markImageBySingleText(String source, String output,
	 ...
	 * @return
	 */
	public static String markImageByMosaic(String source, String output,
			String imageName, String imageType, int size) {
