...
public class CipherUtil {
    ...
    public static String createPwdEncrypt(String username,String password,String salt){
    	  return new Md5Hash(password.toUpperCase(),username+salt,2).toBase64(); 
    }
    /** 
     * 生成随机数字和字母
     * @param length 生成长度
    ...
    public static void main(String[] args) {
    	CPSUtil.xprint(createSalt());
    	
    	CPSUtil.xprint(createPwdEncrypt("admin", "96E79218965EB72C92A549DD5A330112", "321d0c419d5ea6eb70a91ee525b2b29a"));
	}
}