...
public class MemberLoginLog extends BaseEntity {
	...
	private static final long serialVersionUID = 2673466751421390403L;
	...
	public MemberLoginLog(Integer userId, String loginIp) {
		this.userId = userId;
		this.loginIp = loginIp;
	}

	public MemberLoginLog(Integer id, Integer userId, Date loginTime,
			String loginIp) {
		this.id = id;
		this.userId = userId;
