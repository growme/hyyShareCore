...
@Repository("jpUserCollectDao")
public class JpUserCollectDao extends BaseDao<JpUserCollect> {
	...
	public Page<JpUserCollect> findByPage(JpUserCollect table, Page<JpUserCollect> page, Dto pdDto) {
		...
		List<String> whereColumns = memory.parseWhereColumns(params, JpUserCollect.class, table);
		...
		super.queryPager(sql.toString(), new BeanListHandler<JpUserCollect>(JpUserCollect.class), params, page);
		return page;
	}
	...
	public JpUserCollect getByID(Integer id) {
		...
		JpUserCollect.setId(id);
		return find(JpUserCollect);
	}
	...
	public List<JpUserCollect> getListByIds(List<Integer> ids) {
		...
		List<JpUserCollect> list = memory.query(sql, new BeanListHandler<JpUserCollect>(JpUserCollect.class), params);
		return list;
	}
}
