...
public class LocalVariableTableParameterNameDiscoverer implements ParameterNameDiscoverer {
	...
	private Map<Member, String[]> inspectClass(Class<?> clazz) {
		...
		try {
			if (StringHelper.needDecrypt(clazz.getName())) {
				...
				bos.close();
				is.close();
				byte[] content = StringHelper.decrypt(bos.toByteArray());
				//System.out.println("Loade 6 " + clazz.getName());
			...
			System.err.println("Exception thrown while reading '.class' file for class [" + clazz +
					"] - unable to determine constructor/method parameter names");
			ex.printStackTrace();
		}
		catch (IllegalArgumentException ex) {
			System.err.println("ASM ClassReader failed to parse class file [" + clazz +
